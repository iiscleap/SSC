...
def read_arguments():
    ...
    parser.add_argument("--alpha", type=float, default=0.4, help="value of gamma parameter")
    ...
    parser.add_argument("--threshold", type=float, default=None, help='number of cluster or threshold')
    parser.add_argument("--reco2num_spk", type=str, default=None, help='reco2num_spk')
    parser.add_argument("--rttm_ground_path", type=str, default=None, help='der_pickle')
